...
namespace mapManager{
	...
	protected:
		...
		bool collisionUnknownAsOccupied_; // treat unknown cells as occupied in collision service
		double collisionCheckRadius_; // neighborhood radius (m) for collision service
		bool cleanLocalMap_; 
